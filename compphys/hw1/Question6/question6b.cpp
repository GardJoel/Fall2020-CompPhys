...
int main(){
	...
	int max_iteration=20000;  //number of iterations
	int max_period=1000; 	//how many values we'll print
	...
	std::ofstream bfile("bifurcationsb.txt");  //bfile is the file we will print bifurcation data
	...
	for(int riter=0;riter<numdiv;riter++){
        ...
        double x=1000;  //initial value of x
